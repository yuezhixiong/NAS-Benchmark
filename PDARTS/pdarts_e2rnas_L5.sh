save=pdarts_e2rnas_L5
gpu=0

python train_search.py \
--save $save --gpu $gpu \
--layers 5 --add_layers 6 --add_layers 12 --dropout_rate 0.0 --dropout_rate 0.4 --dropout_rate 0.7 \
--nop_outer --adv_outer --flp_outer --ood_inner --MGDA --constrain abs --constrain_min 5 --grad_norm l2
...
model="pdarts_e2rnas_L5/cifar10_channel36/weights.pt"
