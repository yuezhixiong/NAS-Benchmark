...
python test_adv.py --arch $save --batch_size 256 --gpu $gpu --auxiliary --cutout \
--attack FGSM --init_channels 36 --dataset cifar100 \
--model_path "/home/yuezx/NAS-Benchmark/DARTS_LBJ/pgd_nop_min_cifar100/auxiliary0.4_cutout16_batchsize96_channel36_cifar100/best_model.pt"
