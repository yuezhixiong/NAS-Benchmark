...
# --model_path "/home/yuezx/NAS-Benchmark/DARTS_LBJ/DARTS_V2/auxiliary0.4_cutout16_batchsize96_channel36_cifar10/best_model.pt"
...
# python train.py --arch $save --save $save --gpu $gpu --cutout --auxiliary \
# --batch_size 96 --init_channels 19 --dataset cifar100

# python train.py --arch $save --save $save --gpu $gpu --cutout --auxiliary \
# --batch_size 96 --init_channels 27 --dataset cifar100

# python train.py --arch $save --save $save --gpu $gpu --cutout --auxiliary \
# --batch_size 96 --init_channels 34 --dataset cifar100

# python train.py --arch $save --save $save --gpu $gpu --cutout --auxiliary \
# --batch_size 96 --init_channels 34 --dataset svhn

# python train.py --arch $save --save $save --gpu $gpu --cutout --auxiliary \
# --batch_size 96 --init_channels 28 --dataset svhn

# python train.py --arch $save --save $save --gpu $gpu --cutout --auxiliary \
# --batch_size 96 --init_channels 20 --dataset svhn

python test_adv.py --arch $save --batch_size 128 --gpu $gpu --auxiliary --cutout \
--attack PGD --init_channels 19 --dataset cifar100 \
--model_path "/home/yuezx/NAS-Benchmark/DARTS_LBJ/DARTS_V2/auxiliary0.4_cutout16_batchsize96_channel19_cifar100/best_model.pt"