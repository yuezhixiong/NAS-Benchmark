...
# --batch_size 60 --dataset cifar100

python test_adv.py --arch $save --batch_size 32 --gpu $gpu --attack PGD --auxiliary --cutout \
--model_path "/home/yuezx/NAS-Benchmark/DARTS_LBJ/adv_nop_cifar100/auxiliary0.4_cutout16_batchsize68_channel36/best_model.pt"
