...
parser.add_argument('--save', type=str, default='begin_unroll', help='experiment name')
...
def train(train_queue, valid_queue, model, architect, criterion, optimizer, lr,epoch):
  ...
  for step, (input, target) in enumerate(train_queue):
    ...
    loss.backward()
    nn.utils.clip_grad_norm_(model.parameters(), args.grad_clip) # Gradients are modified in-place
    optimizer.step()
