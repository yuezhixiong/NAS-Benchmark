...
parser.add_argument('--save', type=str, default='DARTS_V2', help='experiment name')
...
parser.add_argument('--model_path', type=str, default='DARTS_V2/channel48_imagenet/checkpoint.pth.tar', help='path of pretrained model')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        train_acc, train_acc_top5, train_obj = infer(train_queue, model, criterion)
